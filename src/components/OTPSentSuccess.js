const OTPSentSuccess = ({ email, handleNext }) => {
	return (
		<div className="w-[486px] h-fit mx-auto my-36 flex flex-col justify-center items-center">
			...
			<p
				onClick={handleNext}
				className={`w-full h-16 mx-auto text-center bg-purple-dark text-white cursor-pointer rounded-md shadow-[2px_8px_8px_rgba(86,86,86,0.25)]
