const Social = () => {
	return (
		<div className="w-full h-fit flex justify-between items-center py-7 border-t border-b border-solid border-t-[#63428E] border-b-[#63428E] text-white font-medium">
